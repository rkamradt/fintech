...
class UserControllerTest {
    ...
    private String managerToken() {
        return "Bearer " + jwtUtil.generate(UUID.randomUUID(), "manager", UserRole.MANAGER);
    }
    ...
    @Test
    void createUser_succeeds_withManagerToken() throws Exception {
    ...
    @Test
    void getUser_succeeds_withManagerToken() throws Exception {
